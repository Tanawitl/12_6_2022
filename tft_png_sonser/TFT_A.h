...
//เข้าเงื่อนไข
  ...
  /*
  //tft.fillScreen(tft.color24to16(TFT_BLACK));//สีขาว0xFFFFFF
  ...
  tft.setTextColor(tft.color24to16(0xFFFFFF));//สีข้อความ
  tft.setTextSize(2);//ขนาดข้อความ
  tft.drawString("Heart rate", 5, 195);//ข้อความ
  ...
  //ฟังก์ชั่นรูป
  //tft.setRotation(3);//การหมุนภาพ
  tft.setSwapBytes(true);
  tft.pushImage(20,120,50,50,no1);
*/
